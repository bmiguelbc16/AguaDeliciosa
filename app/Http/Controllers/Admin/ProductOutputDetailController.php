...
class ProductOutputDetailController extends AdminController {
  /**
  ...
  public function index(Request $request) {
    ...
    return response()->view('admin.productOutputs.index', compact('items', 'request'));
  }
  ...
  public function create() {
    ...
    return view('admin.productOutputs.create', compact('isStockEditable'));
  }
  ...
  public function store(ProductRequest $request) {
    ...
    try {
      ...
      return redirect()
        ->route('admin.productOutputs.index')
  ...
  public function show(Product $product) {
    ...
    return view('admin.productOutputs.show', compact('product'));
  }
  ...
  public function edit(Product $product) {
    ...
    return view('admin.productOutputs.edit', compact('product', 'isStockEditable'));
  }
