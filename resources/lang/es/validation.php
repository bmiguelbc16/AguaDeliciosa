...
return [
  ...
  'password' => [
    ...
    'uncompromised' =>
      'El valor del campo :attribute aparece en alguna filtración de datos. Por favor indica un valor diferente.',
  ],
  ...
  'password.uncompromised' =>
    'El atributo :attribute  ha aparecido en una fuga de datos. Elija un :attribute diferente.',
  ...
  'custom' => [
    ...
    'sector.*.block_start' => [
      'required' => 'El campo cuadra de inicio es requerido.',
    ],
    'sector.*.block_end' => [
      'required' => 'El campo cuadra de fin es requerido.',
    ],
  ],
  ...
  'attributes' => [
    ...
    'blocks_count' => 'cantidad de cuadras',
    'address_type_id' => 'tipo de dirección',
    'latitude' => 'latitud',
    'longitude' => 'longitud',
    'reference' => 'referencia',
    'block_start' => 'cuadra de inicio',
    'address' => 'dirección',
    'password' => 'contraseña',
    'first_name' => 'nombre',
