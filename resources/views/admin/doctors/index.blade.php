...
@section('content')
  <div class="row mb-4">
    <div class="col-md-12 d-flex flex-column flex-md-row justify-content-between align-items-md-center">
      <h3 class="mb-2 mb-sm-0">Doctores</h3>
      <div class="d-flex flex-column flex-sm-row">
        <a href="{{ route('admin.doctors.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Nuevo Usuario</a>
      </div>
    </div>
  </div>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            <caption>Listado de doctores en total: {{ $items->total() }}</caption>
            <thead>
              <tr>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group" user="group" aria-label="Acciones">
                      <a href="{{ route('admin.doctors.edit', $item->id) }}" class="btn btn-success">
                        <i data-feather="edit"></i>
                      </a>
                      <button class="btn btn-danger btn-delete"
                        onclick="deleteItem('{{ route('admin.doctors.destroy', $item->id) }}', '{{ route('admin.doctors.index') }}')">
